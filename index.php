            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="admin/admin/login.php" class="page-scroll">
                                <h3>Admin</h3>
                            </a></li>
                    </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Taguig City University, Taguig City University, Taguig City University"></span></h1>

                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Appointment System, Appointment System, Appointment System"></span>
                            </h1>

                            <p class="main-heading-text">WELCOME!<br /></p>

                            <div class="btn-bar">

                                <a href="pro/signin.php" class="btn btn-custom theme_background_color">Make Appointment Now</a>
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <div class="btn-bar">
                                ...
                                <a href="student/system/admin" class="btn btn-custom-outline">Admin</a>
